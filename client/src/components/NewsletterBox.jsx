...
const NewsletterBox = () => {
  ...
  return (
    <div className='text-center'>
        <p className='text-2xl font-medium text-gray-800'>Subscribe now & get 20% off now</p>
        <p className='text-gray-400 mt-3'>
        Subscribe to our newsletter for latest collections, exclusive offers, and updates delivered straight to you.
        </p>
